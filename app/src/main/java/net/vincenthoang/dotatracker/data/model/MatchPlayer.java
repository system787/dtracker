...
public class MatchPlayer {
    ...
    public MatchPlayer(long match_id, long account_id, int player_slot, int hero_id, int level,
                       int item_0, int item_1, int item_2, int item_3, int item_4, int item_5,
                       int kills, int deaths, int assists, int hero_damage, int tower_damage,
                       int hero_healing, int last_hits, int denies, int gold, int gold_per_min,
                       int gold_spent, int xp_per_min, int leaver_status, String personaname,
                       String name, boolean radiant_win, boolean isRadiant) {
